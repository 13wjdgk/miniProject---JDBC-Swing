...
public class MenuDao {
	...
	public MenuDTO findMenuByStoreIdAndName( int storeId , String name) {
		//Menu 테이블과 , MenuCommonCode 조인
		String sql = "select menu_id,store_id,M.name as menu_name ,price,  C.name as category,spice,amount from menu M join MenuCommonCode C on M.category=C.codeId   where store_id = ? and M.name = ?; ";
		MenuDTO menu = null;
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
